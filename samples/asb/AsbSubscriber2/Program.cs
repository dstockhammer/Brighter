...
namespace AsbSubscriber2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            container.Register<IHandleRequests<GreetBCommand>, GreetingBCommandHandler>();

            var subscriberRegistry = new SubscriberRegistry();
            subscriberRegistry.Register<GreetingEvent, GreetingEventHandler>();
            subscriberRegistry.Register<GreetBCommand, GreetingBCommandHandler>();
            ...
            var dispatcher = DispatchBuilder.With()
                ...
                .Connections(new Connection[]
                {
                    new Connection<GreetingEvent>(
                        ...
                        new ChannelName("greeting.event/subscriptions/greeting.event.b"),
                        new RoutingKey("greeting.event"), // todo this doesn't do anything
                        timeoutInMilliseconds: 200),
                    new Connection<GreetBCommand>(
                        new ConnectionName("paramore.example.greeting.b"),
                        new ChannelName("greeting.b.command"),
                        new RoutingKey("greeting.b.command"), // todo this doesn't do anything
                        timeoutInMilliseconds: 200)
                }).Build();
